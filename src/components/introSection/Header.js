...
const Header = () => {
  ...
  return (
    ...
    <div className='w-full max-w-[1200px] mx-auto py-[10px] flex items-center justify-between   px-3 '>
      <img className='w-[80px] h-[45px] lg:w-[149px] lg:h-[50px] cursor-pointer' src="/assets/movix-logo.svg" onClick={() =>{navigate('/')}} alt="hehe"/>
      <div className='flex items-center gap-x-1 lg:gap-x-5 '>
        <span className='cursor-pointer text-[12px] lg:text-[20px]' onClick={click1}>Movies</span>
        <span className='cursor-pointer text-[12px] lg:text-[20px]' onClick = {click2}>TVshows</span>
